...
The agent-native email application path is implemented behind `AGENT_MAIL_ENABLED=false`. It has
not been deployed or connected to AWS/DNS merely by existing in this repository.
