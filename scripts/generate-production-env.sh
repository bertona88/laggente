...
if [[ -n "$source_env" ]]; then
    ...
    printf '%s\n' \
        ...
        'PRODUCT_POSITIONING_JSON={"audience":"Professionisti che lavorano attraverso relazioni, competenza e fiducia, a partire dagli agenti immobiliari.","opening_question":"Che lavoro fai?","featured_verticals":[{"id":"real_estate_it","label":"Agenti immobiliari","weight":100,"status":"pilot","template_id":"seller_it_v1","example_answer":"Sono un agente immobiliare.","headline":"Partiamo dagli agenti immobiliari.","description":"Il primo settore reso concreto dal pilot italiano, senza trasformare la conversazione in una pipeline."}]}' \
