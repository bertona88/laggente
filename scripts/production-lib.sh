...
require_secret_files() {
    ...
    application_allowed='APP_ENV,SESSION_SECRET,BASE_DOMAIN,APP_ORIGIN,CORS_ORIGINS,TRUSTED_HOSTS,COOKIE_SECURE,SESSION_TTL_SECONDS,MAGIC_LINK_TTL_SECONDS,AUTH_MODE,PILOT_EMAIL,PILOT_PASSWORD,PILOT_NAME,SEED_DEMO,AUTO_CREATE_SCHEMA,OPENAI_API_KEY,OPENAI_MODEL,OPENAI_TRANSCRIPTION_MODEL,OPENAI_MAX_TURNS,RESEND_API_KEY,FROM_EMAIL,AGENT_MAIL_ENABLED,AGENT_MAIL_PROVIDER,AGENT_MAIL_FROM_DOMAIN,AGENT_MAIL_REPLY_DOMAIN,AGENT_MAIL_AWS_REGION,AGENT_MAIL_INBOUND_SECRET,AGENT_MAIL_MAX_INBOUND_BYTES,AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY,AWS_SESSION_TOKEN,UPLOAD_DIR,MAX_UPLOAD_BYTES,CONVERSATION_RETENTION_DAYS,PRIVACY_NOTICE_VERSION'
