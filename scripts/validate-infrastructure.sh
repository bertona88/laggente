...
if [[ ${1:-} == --build ]]; then
    ...
    require_gateway_status laggente.com /media/laggente-extension-it-v1.mp4 200
    require_gateway_header laggente.com /media/laggente-extension-it-v1.mp4 Content-Type 'video/mp4'
